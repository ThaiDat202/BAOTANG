...
namespace BAOTANG
{
    ...
    {
        string connectionString = "Data Source=DESKTOP-H0GEECA\\SERVER;Initial Catalog=BAOTANG;User ID=sa;Password=123456";
        public FrmBackup()
        {
            InitializeComponent();
        }
        ...
        private void btn_BackUp_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        SqlCommand command = new SqlCommand("SP_BackupBaoTangDatabase", connection);
