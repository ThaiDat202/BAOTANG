...
namespace BAOTANG
{
    public partial class FrmDieuKhacTacTuong : Form
    {
        string flag = "";
        ...
        public FrmDieuKhacTacTuong()
        {
            InitializeComponent();
            vIEW_DIEUKHACTACTUONGDataGridView.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
        }

        private void FrmDieuKhacTacTuong_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'bAOTANGDataSet.VIEW_DIEUKHACTACTUONG' table. You can move, or remove it, as needed.
            this.vIEW_DIEUKHACTACTUONGTableAdapter.Fill(this.BAOTANGDataSet.VIEW_DIEUKHACTACTUONG);
        ...
        private void vIEW_DIEUKHACTACTUONGDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow selectedRow = vIEW_DIEUKHACTACTUONGDataGridView.SelectedRows[0];
        }
        ...
        {
            vIEW_DIEUKHACTACTUONGBindingSource.CancelEdit();
            btnItemAdd.Enabled = btnItemEdit.Enabled = btnItemDelete.Enabled = btnItemReload.Enabled = btnItemExit.Enabled = vIEW_DIEUKHACTACTUONGDataGridView.Enabled = btnItemReadMore.Enabled = true;
        ...
        private void btnItemReload_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                this.vIEW_DIEUKHACTACTUONGTableAdapter.Connection.ConnectionString = Program.connstr;
                this.vIEW_DIEUKHACTACTUONGTableAdapter.Fill(this.BAOTANGDataSet.VIEW_DIEUKHACTACTUONG);
            }
            catch (Exception ex)
            {
        ...
        private void btnItemAdd_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            btnItemAdd.Enabled = btnItemEdit.Enabled = btnItemDelete.Enabled = btnItemReload.Enabled = btnItemExit.Enabled = vIEW_DIEUKHACTACTUONGDataGridView.Enabled = false;
            vIEW_DIEUKHACTACTUONGBindingSource.AddNew();
            txtMATPNT.Focus();
            flag = "add";
        }
                ...
                try
                {
                    ...
                    void saveLoaiSoHuu(object sender, EventArgs e)
                    {
                        ...
                        try
                        {
                            ...
                            using (SqlCommand command = new SqlCommand("SP_DIEUKHACTACTUONG_ADDLOAISOHUU", Program.conn))
                            {
                                command.CommandType = CommandType.StoredProcedure;
                                ...
                                command.Parameters.AddWithValue("@CHIEUCAO", txtChieuCao.Text);
                        ...
                        {
                            vIEW_DIEUKHACTACTUONGBindingSource.RemoveCurrent();
                            MessageBox.Show("Lỗi: " + ex.Message, "Lỗi", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                    }
                    ...
                    void saveLoaiDiMuon(object sender, EventArgs e)
                    {
                        ...
                        try
                        {
                            using (SqlCommand command = new SqlCommand("SP_DIEUKHACTACTUONG_ADDLOAIDIMUON", Program.conn))
                            {
                                command.CommandType = CommandType.StoredProcedure;
                    ...
                    btnItemAdd.Enabled = btnItemEdit.Enabled = btnItemDelete.Enabled = btnItemReload.Enabled = btnItemExit.Enabled = vIEW_DIEUKHACTACTUONGDataGridView.Enabled = true;
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_MENULOAI", Program.conn))
                    {
                        ...
                        void updateLoaiSoHuu(object sender, EventArgs e)
                        {
                            ...
                            try
                            {
                                ...
                                using (SqlCommand command = new SqlCommand("[SP_DIEUKHACTACTUONG_UPDATELOAISOHUU]", Program.conn))
                                {
                                    command.CommandType = CommandType.StoredProcedure;
                        ...
                        void updateLoaiDiMuon(object sender, EventArgs e)
                        {
                            ...
                            try
                            {
                                ...
                                using (SqlCommand command = new SqlCommand("SP_DIEUKHACTACTUONG_UPDATELOAIDIMUON", Program.conn))
                                {
                                    command.CommandType = CommandType.StoredProcedure;
