                ...
                try
                {
                    ...
                    void saveLoaiSoHuu(object sender, EventArgs e)
                    {
                        ...
                        try
                        {
                            ...
                            using (SqlCommand command = new SqlCommand("SP_HOIHOA_LUULOAISOHUU", Program.conn))
                            {
                                command.CommandType = CommandType.StoredProcedure;
                    ...
                    void saveLoaiDiMuon(object sender, EventArgs e)
                    {
                        ...
                        try
                        {
                            ...
                            using (SqlCommand command = new SqlCommand("SP_HOIHOA_LUULOAIDIMUON", Program.conn))
                            {
                                command.CommandType = CommandType.StoredProcedure;
